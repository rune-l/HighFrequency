...
#%% Run model for all
file_list = glob.glob("./clean_data/*quotes.h5") # Merged data is in quote files #
...
for file in file_list:
    for interval in lInt:
        ...
        name = tick + '_' + interval + '_' + 'cnn'
        
        file_out = './models/results/' + tick + interval + '_' + 'cnn' +'.pickle'
